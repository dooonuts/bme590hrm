...
M = zeros(120000,2);
M(:,1) = linspace(0,120000,120000);
M(:,2) = cat(1,normal_sec,brady_sec,normal_sec,tachy_sec,normal_sec);
figure(1); clf
plot(M(:,1),M(:,2));
M2 = zeros(240000,2);
M2(:,1) = linspace(0,240000,240000);
M2(:,2) = cat(1,M(:,2),M(:,2));

cd('C:\Users\User\Documents');
csvwrite('full_test.csv',M2);